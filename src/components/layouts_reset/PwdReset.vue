    ...
    <div class="row mt-3">
        <div class="col-12">
            <div class="alert alert-secondary">
                ...
                <template v-if="typeof dataRulesPwd.rules == 'object' " >
                    <div v-for="objRule in dataRulesPwd.rules">
        ...
        <div class="col-4">
            ...
            <div class="form-group">
                <input v-model="params.password" type="password" class="form-control" @keyup="pwdValidator(params.password)" placeholder="contraseña"/>
            </div>
        </div>
        <div class="col-4">
            <label>Confirmar Contraseña</label>
            <div class="form-group">
                <input v-model="password_confirm" type="password" class="form-control" @keyup="pwdValidator(params.password)" placeholder="confirmar contraseña"/>
            </div>
        </div>
        <div class="col-4">
            <div class="row">
                <div class="col-8">
                    ...
                    <template v-else>
                        <div class="btn-group" role="group" aria-label="Basic example">
                            <button @click="resetPwd()" title="Confirmar reseteo de contraseña" :disabled="!dataRulesPwd.status" type="button" class="btn btn-success">
                                <i class="fa fa-check-square-o fa-fw"></i>
                                <span>Resetear</span>
                            </button>
                            <button @click="resetGeneratePwd()" title="Obtener y resetear una contraseña autogenerada" :disabled="!dataRulesPwd.status" type="button" class="btn btn-info">
                                <i class="fa fa-undo fa-fw"></i>
                                <span>Auto-Generar</span>
                            </button>
                        </div>
